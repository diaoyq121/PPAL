...
from src.preprocessing import process_sMRIs,preproc_pipeline
...
def main():
    ...
    parser.add_argument('--bids_path', default='/home/diaoyueqin/AXIAL-main/data/ADNI_BIDS', type=str, help='path to the BIDS dataset', required=True)
    parser.add_argument('--n_proc', type=int, help='number of processes to use', default=10)
    parser.add_argument('--checkpoint', type=str, help='path to the checkpoint file', default='checkpoint5.txt')
    ...
    create_dataset_csv_from_bids('/home/diaoyueqin/AXIAL-main/data/ADNI_BIDS')
    # Create the csv file for sMCI vs pMCI progression task
    # print("Creating dataset_conversion.csv file...")
    # create_conversion_dataset_csv_from_bids('/home/diaoyueqin/AXIAL-main/data/ADNI_BIDS', 36)
